...
ShaderProgramSource get_file_contents(const char* filepath)
{
...
Shader::Shader(const char* fileName) {
	ShaderProgramSource source = get_file_contents(fileName);
...
void Shader::SetMat3(const char* uniform, glm::mat3 unit) {
	glUniformMatrix3fv(glGetUniformLocation(ID, uniform), 1, GL_FALSE, glm::value_ptr(unit));
}
